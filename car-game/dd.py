...
carimg=pygame.image.load('car-game/car1.jpg')
backgroundpic=pygame.image.load("car-game/download12.jpg")
yellow_strip=pygame.image.load("car-game/yellow strip.jpg")
strip=pygame.image.load("car-game/strip.jpg")
intro_background=pygame.image.load("car-game/background.jpg")
instruction_background=pygame.image.load("car-game/background2.jpg")
car_width=56
pause=False
...
def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        obs_pic=pygame.image.load("car-game/car.jpg")
    elif obs==1:
        obs_pic=pygame.image.load("car-game/car1.jpg")
    elif obs==2:
        obs_pic=pygame.image.load("car-game/car2.jpg")
    elif obs==3:
        obs_pic=pygame.image.load("car-game/car4.jpg")
    elif obs==4:
        obs_pic=pygame.image.load("car-game/car5.jpg")
    elif obs==5:
        obs_pic=pygame.image.load("car-game/car6.jpg")
    elif obs==6:
        obs_pic=pygame.image.load("car-game/car6.jpg")
